...
if(isset($_POST['single']) && $_POST['single'] == 'single'){
  $checkbox = $_POST['single'];
} else {
  $checkbox = $_POST['multi'];
}
  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.html">
        ...
        <div class="sidebar-brand-text mx-3">Smart Scanner</div>
      </a>
          ...
          <div class="row">
            ...
            <div class="col-sm-6">
              <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    <form name="form" method="post" action="uploadManually.php" enctype="multipart/form-data">
                  <div class="container">
                      ...
                      <div class="form-group">
                        <div class="row">
                          ...
                          <input name="reportTitle" id="report" type="text" class="form-control"/>
                        </div>
                        </div>
                      </div>
                  ...
                  <ul id="myUL">
                    ...
                    foreach ($result as $r){
                      ...
                      <input type="checkbox" name="nameList[]" value=' . $counter . '>
