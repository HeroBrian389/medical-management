                ...
                <div class="card-body">
                  <div class="row">
                    <div class="col-sm-6 text-center">
                      <a href="newScheduleDaily.php"><button type="button" class="btn btn-outline-secondary">Full view</button></a>
                    </div>
                    <div class="col-sm-6 text-center">
                      <a href="newScheduleDailyList.php"><button type="button" class="btn btn-secondary">List view</button></a>
                    </div>
                  </div>
                  <br>
                    ...
                    <tbody>
                      ...
                      foreach ($result as $row){
                        if ($row['type'] == "consultation") {
                          $typeColour = "#95d095";
                        } else if ($row['type'] == "surgery") {
                          $typeColour = "#FF8A65";
                        } else if ($row['type'] == "physio") {
                          $typeColour = "#cc99ff";
                        }
                        echo "<tr>";
                        ...
                        echo "<td>" . $row['end']. "</td>";
                        echo "<td>" . $row['name']."</td>";
                        echo '<td style="background-color: ' . $typeColour . ';">' . $row['type'].'</td>';
