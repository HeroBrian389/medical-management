        ...
        <div class="container-fluid">
              ...
              <div class="card shadow mb-4">
                <div class="card-body" style="padding-bottom: 0px">
                  ...
                  <div class="col-4">
                    <input type="text" class="form-control" name="userDob" placeholder="Date of birth">
                  </div>
                  <div class="col-1">
                    <button class="btn btn-outline-success" type="submit" name="submitUser">Add</button>
                  </div>
                  ...
                  <table id="tableID" class="table" width="100%">
                    ...
                    <tbody>
                      ...
                      foreach ($result as $row){
                        ...
                        echo "<td class='align-middle'>" . $row['dob']."</td>";
                        echo "<td class='align-middle'><button class='btn btn-outline-danger' type='submit' name='delete' value='" . $row['name'] . "'>Delete</td>";
                        echo "<td class='align-middle'><button class='btn btn-outline-warning' type='submit' name='select' value='" . $row['name'] . "'>Select</td>";
                        echo "</tr>";
                      }
                        ?>
