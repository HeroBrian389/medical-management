            ...
            <div class="col-sm-8">
              ...
              <div class="card shadow mb-4">
                <div class="card-header py-3">
                  <h6 class="m-0 font-weight-bold text-primary">View your documents</h6>
                </div>
                <div class="card-body">
                  <form name="form" method="post" action="show.php" enctype="multipart/form-data">
                ...
                <table id="myTable">
                  ...
                  foreach ($result as $r){
                    ...
                    <td>'.$r['name'].'</td>
                    <td>'.$r['dob'].'</td>
                    <td><input type="checkbox" name="nameList[]" value="' . $r['name'] . ' ' . $r['dob'] . '"></td>
                    <input type="hidden" name="name" value="' . $r['name'] . '">
                    <input type="hidden" name="dob" value="' . $r['dob'] . '">
                    </tr>';
                  }
                   ?>
                </table>
