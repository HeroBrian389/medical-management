...
$sql = 'SELECT id, name, dob, report, date, filename FROM Users WHERE name LIKE "'.$name.'" AND email LIKE "' . $_COOKIE['email'] . '";';
              ...
              <div class="col-sm-4">
                ...
                <div class="card shadow mb-4">
                  <div class="card-header py-3">
                    <h6 class="m-0 font-weight-bold text-primary">' . $r['report'] . '
                    <a href="../uploads/' . $_COOKIE['email'] . '/PDF_finished/' . $r['filename'] .'" download>
                    <button type="button" class="float-right btn btn-primary btn-rounded">Download <i class="fa fa-circle fa-download"></i></button>
                    </a>
                    </h6>
                  </div>
                  ...
                  <embed class="embed-responsive-item mx-auto d-block" src="../uploads/' . $_COOKIE['email'] . '/PDF_finished/' . $r['filename'] .'">
                  </div>
                  ' . $r['report'] . '<br>
                  '. $r['date'] .'<br>
                  <hr>
                  <a href="../uploads/' . $_COOKIE['email'] . '/PDF_finished/' . $r['filename'] .'" download>
                  <button type="button" class=" mx-auto d-block btn btn-primary btn-rounded">Download PDF <i class="fa fa-download"></i></button>
                  </a>
                  </div>
                  </div>
                  </div>
