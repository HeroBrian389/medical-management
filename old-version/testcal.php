<?php
    ...
    for ($i=$y-5; $i<=$y+5; $i++){
        echo '<a href="testcal.php?y='.$i.'&m='.$m.'">'.$i.'</a>&nbsp&nbsp;';
    }
    echo "<br><br>";
    ...
    foreach ($m_array as $key=>$val){
        echo '<a href="testcal.php?y='.$y.'&m='.$key.'">'.$val.'</a>&nbsp&nbsp;';
    }
    echo "<br><br>";
    ...
    $prev_m=(($m-1)<=0)?12:($m-1);
    //daisplay next prev
    echo '<tr><td><a href="testcal.php?y='.$prev_y.'&m='.$prev_m.'">Prev</a></td><td></td><td></td><td></td><td></td><td></td><td><a href="testcal.php?y='.$next_y.'&m='.$next_m.'">Next</a></td></tr>';
?>
