...
if (isset($_POST['submit'])){
  ...
  if ($result->num_rows > 0) {
        ...
        $sqlInsert = "INSERT INTO userData (firstName, lastName, dob, email, password) VALUES ('". $firstName."', '". $lastName . "', '" . $dob . "', '" . $email . "', '" . $password1 . "')";
        ...
        // See if any data exists on the user
        $sqlCreate = "CREATE TABLE `". $email."_STATIC_INFO` (id INT AUTO_INCREMENT PRIMARY KEY,
          ...
          info_access VARCHAR(20)
          );";

          if ($conn->query($sqlCreate) === True) {
          }

          $sqlReport = "CREATE TABLE `" . $email . "_REPORT_INFO` (id INT AUTO_INCREMENT PRIMARY KEY,
          firstName VARCHAR(255),
          lastName VARCHAR(255),
          dob VARCHAR(255),
          email VARCHAR(255),
        ...
        $sqlInsertFull = "INSERT INTO `".$email."_STATIC_INFO` (firstName, lastName, dob, email, password, phone) VALUES ('". $firstName."', '". $lastName . "', '" . $dob . "', '" . $email . "', '" . $password1 . "', '" . $phoneNum . "')";
        ...
        // create cookies for the email address to access later
          ...
          $cookie_firstNameValue = $firstName;
          setcookie($cookie_firstName,$cookie_firstNameValue, time() + 3600, "/");

          $cookie_lastName = 'lastName';
          $cookie_lastNameValue = $lastName;
          setcookie($cookie_lastName,$cookie_lastNameValue, time() + 3600, "/");
              ...
              <form action="" method="post" class="user">
                <div class="form-group row">
                  <div class="col-sm-6 mb-3 mb-sm-0">
                    <input name="first_name" type="text" class="form-control form-control-list" id="exampleFirstName" placeholder="First name" required>
                  </div>
                  <div class="col-sm-6">
                    <input name="last_name" type="text" class="form-control form-control-list" id="exampleFirstName" placeholder="Last name" required>
                  </div>
                </div>
                ...
                <div class="col-sm-6">
                  <input name="passwordRepeat" type="password" class="form-control form-control-list" id="exampleInputPassword" placeholder="Repeat Passowrd" required>
                </div>
              </div>
                <div class="form-group row mb-3">
                  <div class="col-sm-4">
                  <select name="date" class="custom-select form-control form-control-list" required>
                  ...
                  <div class="col-sm-4">
                  <select name="month" class="custom-select form-control form-control-list">
                  ...
                  <div class="col-sm-4">
                    <input name="year" type="text" class="form-control form-control-list" id="exampleYear" placeholder="Year" required>
                  </div>
                </div>
