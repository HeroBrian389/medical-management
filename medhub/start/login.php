...
if (isset($_POST['email'])){
  ...
  $success = False;
  $sql = "SELECT * FROM userData WHERE email LIKE '". $email ."' AND password LIKE '" . $password1."';";
            ...
            <div class="row">
              ...
              <div class="col-lg-6">
                <div class="p-5">
                  ...
                  <div class="text-center">
                    <a class="small text-danger" href="hospitalLogin.php">Hospital Login</a>
                  </div>
                </div>
              </div>
            </div>
