      ...
      <div id="content">
        ...
        <div class="col middle-wrapper">
          ...
          <div class="card shadow mb-3">
            ...
            <button class="btn btn-sm btn-outline-primary" data-toggle="modal" data-target="#expandPDF">
              Show PDF
            <i class="fas fa-expand ml-1"></i>
          </button>
        <button class="btn btn-sm btn-outline-primary">
          Download PDF<i class="fas fa-download fa-fw mx-1"></i>
        </button>
              </div>
            </div>
            <div class="row">
      ...
      <div class="modal-dialog modal-lg">
        <div class="modal-content">
          ...
          <div class="modal-body">
            <div class="embed-responsive embed-responsive-210by297" style="height: 70vh;">
              <iframe class="embed-responsive-item" src="assets/Thomas Mcgurk.pdf#toolbar=0&zoom=Scale&navpanes=0" height="100%"></iframe>
            </div>
          </div>
          <div class="modal-footer">
